...
public class adminActivityModel {
    ...
    public adminActivityModel(String name, String url, String key, String noreg, String pangkatnm, String satuan, String pasal, String noputusan, String noeksekusi, String tglarsip, String norak, String noarsip) {
        this.name = name;
        this.url = url;
        this.key = key;
        this.noreg = noreg;
    ...
    public adminActivityModel(String name, String url, String key) {
        this.name = name;
        this.url = url;
        this.key = key;
